...
import { getPageIDFromCollectionPageURL } from "../src/notion-utils"
import { Table } from "../src/table"
import { NTable } from "../src/ntable"

async function main() {
  try {
    const pageId = getPageIDFromCollectionPageURL("https://www.notion.so/595365eeed0845fb9f4d641b7b845726?v=a1cb648704784afea1d5cdfb8ac2e9f0")
    const collectionPage = (await getOnePageAsTree(pageId, createAgent())) as NAST.CollectionPage
    ...
    console.dir(table2.id, { depth: 2 })
    console.dir(table2.records[0].properties.get(table2.schema[0]), { depth: 2 })
